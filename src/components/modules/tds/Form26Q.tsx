      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Form 26Q - TDS Quarterly Return (Non-Salary)</h1>
          </div>
          ...
          {activeTab === 'returns' && (
            <div className="space-y-6">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h3 className="font-semibold text-green-900 mb-2">Form 26Q Overview</h3>
                <p className="text-sm text-green-700">
                  Quarterly TDS return for payments other than salary (sections 193, 194, 194A, 194B, 194BB, 194C, 194D, 194E, 194EE, 194F, 194G, 194H, 194I, 194J, 194K, 194LA, 194LB, 194LC, 194M, 194N, 194O, 195, 196A, 196B, 196C, 196D).
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-blue-600">Filed</div>
                </div>
          ...
          {activeTab === 'generate' && (
            <div className="space-y-6">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h3 className="font-semibold text-green-900 mb-2">Generate Form 26Q</h3>
                <p className="text-sm text-green-700">
                  Generate quarterly TDS return for non-salary payments including professional fees, rent, commission, etc.
                </p>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-bold text-gray-900">₹15,50,000</div>
                  </div>
                  <div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <div className="text-sm text-blue-600">Section 194C (Contractor)</div>
                    <div className="text-lg font-bold text-blue-900">₹8,50,000</div>
                  </div>
                  <div>
                    <div className="text-sm text-blue-600">Section 194J (Professional)</div>
                    <div className="text-lg font-bold text-blue-900">₹4,50,000</div>
                  </div>
                  <div>
                    <div className="text-sm text-blue-600">Section 194I (Rent)</div>
                    <div className="text-lg font-bold text-blue-900">₹2,50,000</div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-sm text-yellow-700">
                  Upload the acknowledgment file received after filing Form 26Q with the Income Tax Department.
                </p>
