...
function RoleManagement() {
  ...
  async function handleAddRole() {
    ...
    const permsPayload = Object.entries(roleForm.selection)
      .filter(([sid, permIds]) => (permIds as number[]).length > 0)
...
function RoleForm({ roleForm, setRoleForm, permissions, screens, isSystem }: {
  roleForm: any, setRoleForm: any, permissions: Permission[], screens: Screen[], isSystem: boolean
}) {
