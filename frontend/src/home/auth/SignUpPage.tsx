...
const SignupPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-purple-600 to-purple-800 bg-cover bg-center bg-no-repeat">
        ...
        <div className="w-full lg:w-1/2 max-w-lg mx-auto">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-[#6D30D4] mb-2">Create Account</h2>
              <p className="text-gray-600">Join thousands of businesses using TallyPrime</p>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <input
                    ...
                    } rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#6D30D4] focus:border-transparent bg-white/80 backdrop-blur-sm transition-all duration-200`}
              ...
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-4 w-4 text-[#6D30D4] focus:ring-[#6D30D4] border-gray-300 rounded mt-1"
                />
                <label htmlFor="agreeToTerms" className="ml-3 text-sm text-gray-600">
                  I agree to the{' '}
                  <Link to="/privacy-policy" className="text-[#6D30D4] hover:text-[#5a2bb5] font-medium">
                    Terms and Conditions
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy-policy" className="text-[#6D30D4] hover:text-[#5a2bb5] font-medium">
              ...
              <div className="text-center">
                <div className="text-sm text-gray-600">
                  ...
                  <Link to="/login" className="font-medium text-[#6D30D4] hover:text-[#5a2bb5] transition-colors">
                    Sign in
                  </Link>
                </div>
              </div>
