...
exports.createAdmin = (0, middlewares_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (validData.role === "admin") {
        const existingAdmin = yield services_1.AdminService.findFirstAdmin(); // You need to implement this
        if (existingAdmin) {
    ...
    return (0, utils_2.SuccessResponse)(res, "Sub Admin Created Successfully", newSubAdmin, types_1.statusCode.Created);
}));
...
exports.AllAdmins = (0, middlewares_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, utils_2.SuccessResponse)(res, "Admins fetched successfully", admins, types_1.statusCode.OK);
}));
exports.getAdminById = (0, middlewares_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, utils_2.SuccessResponse)(res, "sub admin fetched successfully", admin);
}));
exports.deleteById = (0, middlewares_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, utils_2.SuccessResponse)(res, "Sub Admin deleted Successfully");
}));
